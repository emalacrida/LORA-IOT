/*
   E32-TTL-100 Transceiver test code for RX/TX operations
...
#define SOFT_RX 10
#define SOFT_TX 11
#define RXTX_SWITCH 9        // Rx/Tx mode selection 0=Rx   1=Tx
...
void setup() {
  ...
  pinMode(RXTX_SWITCH, INPUT);

  softSerial.begin(9600);
  Serial.begin(9600);

bool Tx_enable = RXTX_SWITCH;
...
RET_STATUS SendMsg()
{
  ...
  uint8_t SendBuf[4] = { DEVICE_A_ADDR_H, DEVICE_A_ADDR_L, 0x17, 0xFF}; //for B
#endif
